'use client'
import { Search, FileX, RefreshCw, ArrowLeft, Newspaper, TrendingUp } from "lucide-react";
    ...
    <div className="flex flex-col items-center justify-center py-16 px-6">
      ...
      <div className="relative mb-8">
        ...
        <div className="relative">
          <div className="w-32 h-32 bg-gradient-to-br from-primary/10 to-primary/5 rounded-full flex items-center justify-center mb-4">
      ...
      <div className="text-center max-w-md">
        ...
        <p className="text-lg text-dark-3 mb-8 leading-relaxed">
          ...
          Our newsroom is constantly updating with fresh stories.
        </p>
