              ...
              <div className="p-6">
                ...
                <div className="prose prose-lg max-w-none mb-6">
                  <p className="text-dark-3 leading-relaxed mb-4">
                    ...
                    U.S. military aid for Ukraine and other European allies,
                    marking the largest single package of assistance since the
                    conflict began.
                  </p>
                  <p className="text-dark-3 leading-relaxed">
                    This unprecedented commitment demonstrates the
                    administration&apos;s continued support for Ukraine&apos;s
                    defense efforts and regional stability in Eastern Europe...
                  </p>
                </div>
              ...
              <div className="card-content">
                ...
                <div className="space-y-1 -mx-2">
                  ...
                  >
                    ...
                    <span className="ml-auto text-xs text-dark-4">
                      12.5k followers
                    </span>
                  </a>
                  <a
