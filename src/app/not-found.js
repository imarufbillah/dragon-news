...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-linear-to-br from-dark-8 via-white to-primary-light flex flex-col">
      {/* Main Content */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative mb-12">
            ...
            <div className="relative">
              <h1 className="text-[12rem] md:text-[16rem] font-black text-transparent bg-linear-to-r from-primary via-primary-hover to-error bg-clip-text leading-none select-none">
                404
              </h1>
          ...
          <div className="mb-12 space-y-6">
            ...
            <p className="text-lg md:text-xl text-dark-3 max-w-2xl mx-auto leading-relaxed">
              The news story you&apos;re looking for seems to have disappeared
              into the digital void. Don&apos;t worry, our newsroom is always
              buzzing with fresh content!
            </p>
          </div>
